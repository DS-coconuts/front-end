  ...
  return (
    <div>
      ...
      >
        ...
        <XAxis dataKey="time" tick={{ fill: '#FFFFFF', fontSize: '12px'}} />
        <YAxis  tick={{ fill: '#FFFFFF', fontSize: '12px'}} />
        <Tooltip contentStyle={{ backgroundColor: '#F1B4BB', fontSize: '15px', borderRadius: '5px', border: 'none', width: '65px', height: '70px'}}
